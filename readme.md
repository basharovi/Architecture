...
public sealed class CustomerService : ICustomerService
{
    ...
    public async Task<IResult<long>> AddAsync(CustomerModel model)
    {
        ...
        var customer = CustomerFactory.Create(model);
...
public abstract class CustomerModelValidator : Validator<CustomerModel>
{
    ...
    public CustomerModelValidator Name()
    {
...
{
    public AddCustomerModelValidator() => Name().Surname().Email();
}
```
...
{
    public UpdateCustomerModelValidator() => Id().Name().Surname().Email();
}
```
...
public sealed class CustomerConfiguration : IEntityTypeConfiguration<Customer>
{
    public void Configure(EntityTypeBuilder<Customer> builder)
    {
        ...
        builder.OwnsOne(customer => customer.FullName, ownsOne =>
        {
            ownsOne.Property(fullName => fullName.Name).HasColumnName(nameof(FullName.Name)).HasMaxLength(100).IsRequired();

            ownsOne.Property(fullName => fullName.Surname).HasColumnName(nameof(FullName.Surname)).HasMaxLength(200).IsRequired();
        });
...
public static class CustomerExpression
{
    public static Expression<Func<Customer, CustomerModel>> Model => customer => new CustomerModel
    {
        ...
        Surname = customer.FullName.Surname,
